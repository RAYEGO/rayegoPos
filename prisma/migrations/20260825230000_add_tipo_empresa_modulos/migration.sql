...
VALUES
  ('10000000-0000-0000-0000-000000000001', 'dashboard',        'Dashboard',         'Panel principal con métricas y KPIs.',                    'LayoutDashboard', 10,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000002', 'ventas',           'Ventas',            'Registro y cobro de ventas mostrador.',                    'ShoppingCart',  20,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000003', 'compras',          'Compras',           'Órdenes de compra y recepciones a proveedores.',           'Truck',         30,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000004', 'productos',        'Productos',         'Catálogo maestro de productos y servicios.',               'Package',       40,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000005', 'inventario',       'Inventario',        'Saldos de stock y movimientos de inventario.',             'Boxes',         50,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000006', 'lotes',            'Lotes',             'Gestión de lotes, vencimientos y trazabilidad.',           'ClipboardList', 55,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000007', 'kardex',           'Kardex',            'Kardex valorizado de productos farmacéuticos.',            'BookOpen',      57,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000008', 'clientes',         'Clientes',          'Registro de clientes y estado de cuenta.',                 'Users',         60,  'GESTION',      true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000009', 'proveedores',      'Proveedores',       'Registro de proveedores y condiciones comerciales.',       'Store',         70,  'GESTION',      true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000010', 'caja',             'Caja',              'Apertura, cierre, movimientos y conciliación de caja.',    'CreditCard',    80,  'OPERATIVO',    true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000011', 'usuarios',         'Usuarios',          'Gestión de usuarios, roles y asignaciones.',               'ClipboardList', 90,  'GESTION',      true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000012', 'sesiones',         'Sesiones',          'Administración de sesiones activas y revocación.',         'Monitor',       92,  'GESTION',      true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000013', 'auditoria',        'Auditoría',         'Historial de acciones y cambios del sistema.',             'FileSearch',    94,  'GESTION',      true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000014', 'reportes',         'Reportes',          'Reportes operativos, financieros y gerenciales.',          'BarChart3',     100, 'GESTION',      true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000015', 'configuracion',    'Configuración',     'Parámetros operativos, sucursales y empresa.',             'Settings',      110, 'CONFIGURACION',true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  -- Nuevos SERVICIO_TECNICO
  ('10000000-0000-0000-0000-000000000101', 'equipos',            'Equipos',              'Registro de equipos y dispositivos de clientes.',               'Server',        41, 'OPERATIVO',   true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000102', 'ordenes_servicio',    'Órdenes de servicio',   'Flujo de órdenes de servicio / tickets.',                      'Ticket',        42, 'OPERATIVO',   true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000103', 'diagnostico',        'Diagnóstico',          'Registro de diagnósticos técnicos por equipo.',                'Stethoscope',   43, 'OPERATIVO',   true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000104', 'presupuestos',       'Presupuestos',         'Presupuestos aprobados por cliente / orden servicio.',        'FileText',      44, 'OPERATIVO',   true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000105', 'reparaciones',       'Reparaciones',         'Progreso y detalle de reparaciones en curso.',                'Hammer',        45, 'OPERATIVO',   true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('10000000-0000-0000-0000-000000000106', 'entregas',           'Entregas',             'Entrega de equipos reparados al cliente.',                    'PackageCheck',  46, 'OPERATIVO',   true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT ("codigo") DO NOTHING;
