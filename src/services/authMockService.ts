...
const MODULOS_RAYEGOTECH = [
  ...
  'sesiones',
  'auditoria',
  // Cross-available for RayegoTech admin full access
  'ventas',
  'productos',
  'compras',
  'proveedores',
...
const DEMO_ACCOUNTS = [
  ...
  },
  {
    ...
    session: createSession({
      ...
      email: 'admin@rayego.pe',
      fullName: 'Administrador de Empresa · Rayego Botica',
  ...
  {
    email: 'admin-tech@rayego.pe',
    password: 'RayegoPOS2026!',
    session: createSession({
      accessToken: 'mock-access-token-admin-tech',
      refreshToken: 'mock-refresh-token-admin-tech',
      id: '5b2c9f11-7a8b-42f0-c0d3-3f0e5a9ecb22',
      email: 'admin-tech@rayego.pe',
      fullName: 'Administrador de Empresa · RayegoTech',
      companyId: '9e57d3a0-b1c4-4f1e-8a3c-9c7b1a4e5555',
      companyName: 'RayegoTech Servicios Técnicos SAC',
      companyTypeId: '00000000-0000-0000-0000-000000000002',
      companyTypeCode: 'RAYEGOTECH',
      enabledModules: MODULOS_RAYEGOTECH,
      branchId: '6d3e4ac2-1e0a-4de0-aa88-8f1b2b7e4d4d',
      branchCode: 'RT-SEDE',
      branchName: 'Sede Principal RayegoTech',
      roles: ['ADMIN_EMPRESA'],
    }),
  },
  {
